...
| `pi-web-access` | Multi-provider web search, raw and page-grounded retrieval, stored-page passage lookup, GitHub access, optional layout-aware PDF extraction, and direct image/media retrieval |
